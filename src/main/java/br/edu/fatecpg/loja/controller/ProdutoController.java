...
public class ProdutoController {
    ...
    public String adicionarProduto(
        ...
        try {
            ...
            String apiUrl = "https://aqua-expense-shoppers-zoloft.trycloudflare.com/itens";
    ...
    public String abrirFormularioEdicao(@PathVariable Long id, Model model) {
        try {
            String apiUrl = "https://aqua-expense-shoppers-zoloft.trycloudflare.com/itens/" + id;
    ...
    public String editarProduto(
        ...
        try {
            ...
            dadosObj.put("nome", nome);
            dadosObj.put("descricao", descricao);
            dadosObj.put("preco", precoDouble); // Usa a variável convertida
            dadosObj.put("categoria", categoria);
            dadosObj.put("qtd", qtd);
    ...
    public String diminuirQuantidade(@RequestParam Long id, HttpSession session) {
        try {
            ...
            String baseUrl = "https://aqua-expense-shoppers-zoloft.trycloudflare.com/itens/";
